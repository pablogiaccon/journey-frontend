...
export const Input: React.FC<TInput> = (props) => {
  ...
  return (
    <div>
      <div className="px-4 flex items-center flex-1 gap-2 h-14 shadow-shape rounded-lg bg-zinc-950 border border-1 border-zinc-800 outline outline-1 outline-offset-2 outline-transparent focus-within:outline-lime-300 transition">
